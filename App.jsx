...
const App = () => {
  ...
  const INITIAL_URL = `https://velvet-lake-haven.space/`;
  const URL_IDENTIFAIRE = `no9JPr0a`;
  ...
  OneSignal.initialize('f7eac76c-be43-4f47-a69d-b4e477393847');
  ...
  return (
    <NavigationContainer>
      <ContextProvider>
        {!loader ? <Loader /> : <Route isFatch={route} />}
      </ContextProvider>
    </NavigationContainer>
  );
};
